...
Additionally, it supports the environment `xplain` for borderless plain text that may span multiple pages and the non-verbatim environment `boxed`, which places a box around Markdown code.
